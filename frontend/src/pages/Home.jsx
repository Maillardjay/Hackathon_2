        ...
        <div className="w-1/3 pb-5 pr-5 animate-fade-down animate-once animate-duration-800 animate-delay-700 max-[820px]:w-full ">
          <div className="block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
            ...
            <div className="p-6">
              ...
              <button
                type="button"
                className="inline-block rounded bg-cyan-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-cyan-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] "
                data-te-ripple-init
                data-te-ripple-color="light"
              >
                En savoir plus
